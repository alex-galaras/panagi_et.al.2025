...
FASTQ_PATH=$HOME_PATH/fastq_files
HISAT2_OUTPUT=$HOME_PATH/fastq_files/hisat_files #the dir inside home_path dir, where hisat2 output files will be stored 
...
do	
	SAMPLE=`basename $FILE | sed s/\.fastq// | sed s/\.IonXpress*//`  
